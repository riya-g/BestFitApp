...
public class Breakfast extends AppCompatActivity {
    ...
    public void selectItem1(View view){
        ...
        if(checked){
            selected.add(0,100);
            Log.d(TAG,"The eggs are checked"+String.valueOf(selected.get(0)));
        }else{
            selected.add(0,0);
            Log.d(TAG,"The eggs are unchecked"+String.valueOf(selected.get(0)));
        }
    ...
    public void selectItem2(View view){
        ...
        if(checked){
            selected.add(1,100);
            Log.d(TAG,"The chickens are checked"+String.valueOf(selected.get(1)));
        }else{
            selected.add(1,0);
            Log.d(TAG,"The chickens are unchecked"+String.valueOf(selected.get(1)));
        }
    }
    ...
    public void selectItem3(View view){
        ...
        if(checked){
            selected.add(2,100);
            Log.d(TAG,"The milk is checked"+String.valueOf(selected.get(2)));
        }else{
            selected.add(2,0);
            Log.d(TAG,"The milk is unchecked"+String.valueOf(selected.get(2)));
        }
